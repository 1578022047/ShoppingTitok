...
import com.example.dou.ui.activity.GoodsRetailActivity;
...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.ViewHolder> implements BaseQuickAdapter.RequestLoadMoreListener {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            goods_retail=view.findViewById(R.id.goods_retail);
        }
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        Glide.with(context).load(videos.get(i).getImageUrl())
                .into(viewHolder.goods_retail);
        viewHolder.goods_retail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(context, GoodsRetailActivity.class);
                intent.putExtra("goods",videos.get(i));
                intent.putExtra("userId",users.get(i));
